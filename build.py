...
.skill-dd-trigger { display:flex; align-items:center; gap:8px; padding:5px 10px 5px 13px; border-radius:2px; cursor:pointer; font-size:12px; font-weight:700; border:1px solid var(--border2); background:var(--card); color:var(--blue); transition:all 0.12s; min-width:210px; white-space:nowrap; }
.skill-dd-trigger:hover { background:var(--bg2); }
...
.skill-dd-menu { position:absolute; top:calc(100% + 4px); left:0; min-width:230px; background:var(--card); border:1px solid var(--border2); border-radius:2px; box-shadow:0 4px 16px rgba(0,0,0,0.1); z-index:500; overflow:hidden; visibility:hidden; opacity:0; transform:translateY(-6px); transition:opacity 0.14s, transform 0.16s ease, visibility 0.14s; pointer-events:none; }
...
.skill-dd-item { display:flex; align-items:center; gap:9px; padding:7px 11px; cursor:pointer; font-size:12px; font-weight:500; color:var(--text2); border-radius:2px; transition:background 0.1s; }
.skill-dd-item:hover { background:var(--bg2); color:var(--text); }
.skill-dd-item.active { font-weight:700; }
.skill-dd-sep { height:1px; background:var(--border); margin:3px 4px; }

/* ===== POPUP MODAL (htdk/dien) ===== */
.popup-overlay { position:fixed; inset:0; z-index:1000; background:rgba(15,20,30,0.5); display:flex; align-items:center; justify-content:center; padding:20px; opacity:0; pointer-events:none; transition:opacity 0.18s; }
.popup-overlay.open { opacity:1; pointer-events:all; }
.popup-box { background:var(--card); border:1px solid var(--border2); border-radius:2px; width:100%; max-width:740px; max-height:88vh; overflow:hidden; display:flex; flex-direction:column; box-shadow:0 8px 32px rgba(0,0,0,0.12); transform:translateY(10px); transition:transform 0.18s ease; }
...
.popup-close { width:32px; height:32px; border-radius:2px; border:1px solid var(--border); background:var(--bg2); color:var(--text3); cursor:pointer; font-size:16px; display:flex; align-items:center; justify-content:center; transition:all 0.12s; flex-shrink:0; }
.popup-close:hover { background:var(--red); color:white; border-color:var(--red); }
...
.popup-section { background:var(--bg2); border:1px solid var(--border); border-radius:2px; padding:12px 14px; }
...
#other-container .fc-front { background:var(--card); border:1px solid var(--border); }
#other-container .fc-back { background:var(--card2); border:1px solid var(--border2); transform:rotateY(180deg); overflow-y:auto; text-align:left; align-items:stretch; }

/* ===== VAN/INSTRU SKILL – STRUCTURED BROWSE ===== */
.van-section { margin-bottom:24px; }
.van-sec-hdr { display:flex; align-items:center; gap:10px; padding:8px 0 10px; border-bottom:1px solid var(--border); margin-bottom:12px; }
.van-sec-bar { width:3px; height:18px; border-radius:0; flex-shrink:0; }
.van-sec-title { font-size:11px; font-weight:800; letter-spacing:0.09em; text-transform:uppercase; }
...
.van-card:hover { border-color:var(--border2); }
...
.van-name { font-size:13px; font-weight:700; line-height:1.3; margin-bottom:2px; }
...
.van-cell { background:var(--bg2); border:1px solid var(--border); border-radius:2px; padding:5px 7px; min-width:0; overflow:hidden; }
...
.van-chip { display:inline-flex; align-items:center; padding:2px 6px; border-radius:2px; font-size:10px; font-weight:600; background:var(--bg3); border:1px solid var(--border2); color:var(--text2); line-height:1.5; white-space:nowrap; transition:all 0.12s; }
.van-chip.cpt { cursor:pointer; }
.van-chip.cpt:hover { background:rgba(37,99,235,0.08); border-color:rgba(37,99,235,0.3); color:var(--blue); }
...
.van-card-ft:hover { background:var(--bg2); }
.van-card-ft span { font-size:10px; color:var(--text3); font-weight:600; }
.van-card-ft:hover span { color:var(--blue); }
'''
