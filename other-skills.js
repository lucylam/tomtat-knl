...
,
  ...
  instru: {
    ...
    concepts: {
      ...
      rtd_wiring: { title:'RTD – Sơ đồ đấu dây 3-wire & 4-wire', e:'🔌',
        body:'Điện trở dây dẫn (Rl) cộng thêm vào phép đo RTD → gây sai số nhiệt độ:\n• 2-wire: không bù được Rl → sai số lớn, chỉ dùng khi cáp ngắn và yêu cầu thấp.\n• 3-wire (phổ biến nhất): 2 dây từ 1 cực + 1 dây từ cực kia, cùng chiều dài → cầu Wheatstone bù được 1 Rl → sai số còn lại < 0.1 °C.\n• 4-wire (Kelvin): 2 dây nguồn + 2 dây đo hoàn toàn riêng biệt → bù toàn bộ 2 Rl → chính xác nhất (±0.01 °C), dùng cho hiệu chuẩn chuẩn.\nNM Đạm Cà Mau chủ yếu lắp PT100 3-wire.',
        note:'Dùng cáp cùng tiết diện và chiều dài cho 3 dây của RTD 3-wire để bù chính xác.' },
      pressure_mech: { title:'Phần tử đo cơ học – Bourdon / Diaphragm / Bellows', e:'🔩',
        body:'3 kiểu phần tử đàn hồi cảm nhận áp suất trong đồng hồ đo áp cơ học:\n• Bourdon tube: ống kim loại cong dạng C hoặc xoắn. Áp tăng → ống duỗi thẳng → kéo thanh truyền → quay kim chỉ thị. Phổ biến nhất, dải 0.1–700 bar.\n• Diaphragm (màng): tấm kim loại mỏng đàn hồi biến dạng dưới áp. Nhạy với áp thấp (<1 bar), phù hợp lưu chất ăn mòn (vật liệu SS/PTFE).\n• Bellows/Capsule: nhiều lớp màng ghép → biến dạng lớn hơn → đo áp rất thấp (<100 mbar).\nTất cả đều chuyển áp thành chuyển vị cơ học → quay kim qua thanh truyền.',
        note:'Glycerin-filled đồng hồ giảm rung kim trong môi trường rung mạnh (gần máy bơm/máy nén).' },
      piezores: { title:'Piezoresistive – Cảm biến áp điện trở silicon', e:'💡',
        body:'Nguyên lý: Áp suất → uốn màng silicon → điện trở bán dẫn thay đổi (hiệu ứng piezoresistive).\nCấu tạo: 4 điện trở piezoresistive khắc lên màng silicon (MEMS) tạo cầu Wheatstone. Khi màng uốn cong → 2 điện trở tăng, 2 giảm → điện áp mất cân bằng ∝ áp suất.\nƯu điểm: nhỏ gọn, nhạy, đáp ứng nhanh, giá thấp hơn capacitance.\nNhược điểm: nhạy cảm nhiệt độ (cần bù điện tử), dải đo hẹp hơn.\nSo sánh: Differential Capacitance (Rosemount 3051) dùng cho áp rất thấp (mbar). Piezoresistive (Yokogawa EJA silicon resonant) dùng cho áp cao, đáp ứng nhanh.',
        note:'Yokogawa EJA dùng silicon resonant sensor; Rosemount 3051 dùng differential capacitance.' },
      dp_level_comp: { title:'DP Level – Wet Leg / Suppression / Elevation', e:'📐',
        body:'DP TX đặt bên ngoài bình → cần hiệu chỉnh zero theo cấu hình lắp đặt:\n• Dry leg (bình hở / thông khí): LP-port thông khí trời → không cần bù, zero = 0.\n• Wet leg (bình kín / có hơi): LP-leg luôn đầy nước ngưng tụ → tạo áp offset cố định trên LP-port → phải Suppress zero (dịch zero về âm) để LP-leg không làm lệch phép đo.\n• Compensated leg: sealed leg đổ đầy dầu silicon ổn định → bù áp LP ổn định, không phụ thuộc nhiệt độ môi trường.\n• Zero Elevation: TX đặt thấp hơn điểm zero bình → HP-leg có thêm cột áp tĩnh → shift zero âm.\n• Zero Suppression: TX đặt cao hơn điểm zero bình → shift zero dương.',
        note:'Sai lầm phổ biến: quên bù wet leg → TX luôn chỉ sai một offset cố định ở mọi mức.' },
      venturi_pitot: { title:'Venturi & Annubar – DP Flowmeter tổn thất áp thấp', e:'🌊',
        body:'Biến thể DP flowmeter khắc phục nhược điểm tổn thất áp lớn của orifice:\n• Venturi tube: hình côn thu dần vào họng → mở rộng từ từ ra → phục hồi áp ~90% (orifice chỉ ~50%). Cd ≈ 0.98, chính xác ±0.3%. Không bị cặn bám, dùng được cho lưu chất bẩn, dầu thô, bùn nhẹ.\n• Annubar (Averaging Pitot Tube, e.g. Rosemount 485): thanh đa lỗ lấy áp trung bình trên toàn tiết diện ống. Tổn thất áp < 5%, phù hợp ống lớn D > 200 mm, lắp không cần tháo flanges.\nCả hai vẫn theo nguyên lý: Q ∝ √ΔP, ghép với DP Transmitter.',
        note:'Venturi: chọn khi cần ±0.3% và lưu chất bẩn. Annubar: chọn khi ống lớn không dừng dây chuyền.' },
      ff_fieldbus: { title:'Foundation Fieldbus H1 – Bus trường kỹ thuật số', e:'🔗',
        body:'Foundation Fieldbus H1 là giao thức bus trường kỹ thuật số thay thế tín hiệu 4-20mA truyền thống:\n• Tốc độ: 31.25 kbit/s (H1 – cấp field)\n• Cung cấp nguồn và dữ liệu trên cùng 1 cặp dây (bus-powered)\n• Đa điểm (multi-drop): đến 32 thiết bị / segment\n• Mỗi thiết bị có địa chỉ riêng, truyền nhận song công\n• Function Block: PID, AI, AO, DI, DO chạy ngay trên thiết bị field\n• HSE (High Speed Ethernet): 100 Mbit/s, kết nối segment H1 với DCS\nƯu điểm: giảm đi dây, chuẩn đoán từ xa, điều khiển phân tán.\nHãng: Emerson, Yokogawa, Siemens, ABB.',
        note:'Foundation Fieldbus H1 được dùng tại một số vị trí critical trong NM Đạm Cà Mau.' },
      isa100: { title:'ISA100.11a Wireless – Chuẩn không dây công nghiệp', e:'📡',
        body:'ISA100.11a (IEC 62734) là chuẩn wireless cho thiết bị đo lường công nghiệp:\n• Tần số: 2.4 GHz (IEEE 802.15.4)\n• Mesh network: các thiết bị relay tín hiệu cho nhau\n• Bảo mật: mã hóa AES-128\n• Chu kỳ cập nhật: 1 giây đến vài phút (có thể cấu hình)\n• Pin: 5-10 năm với chu kỳ phù hợp\n• So với WirelessHART: ISA100 linh hoạt hơn, hỗ trợ nhiều loại protocol\nỨng dụng: vị trí khó đi dây, di động, mở rộng hệ thống cũ.\nHãng: Yokogawa (ISA100 specialist), Emerson WirelessHART.',
        note:'WirelessHART và ISA100 là 2 chuẩn không dây phổ biến nhất trong công nghiệp.' },
    },
    ...
    data: [
      ...
      { id:0, stt:'T1', cat:'temp', name:'RTD – Resistance Temperature Detector (PT100)', sub:'PT100 · α=0.00392 · 3-wire/4-wire · Rosemount/E+H/Yokogawa',
        cells:[
          ...
          { l:'Kết nối dây',     c:[{t:'3-wire (bù 1 dây)',k:'rtd_wiring'},{t:'4-wire (bù 2 dây)',k:'rtd_wiring'}] },
          { l:'Hãng tại NM',     c:[{t:'Rosemount'},{t:'E+H'},{t:'Yokogawa'}] },
          { l:'Tín hiệu ra',     c:[{t:'4-20mA + HART',k:'tx_4_20'},{t:'FF Foundation Fieldbus',k:'ff_fieldbus'}] },
        ],
      ...
      { id:2, stt:'T3', cat:'temp', name:'Temperature Transmitter & Thermowell', sub:'4-20mA · Smart HART · Thermowell bảo vệ · Rosemount/E+H',
        cells:[
          { l:'Transmitter',    c:[{t:'4-20mA + HART',k:'tx_4_20'},{t:'Foundation Fieldbus',k:'ff_fieldbus'},{t:'ISA100 Wireless',k:'isa100'}] },
      ...
      { id:3, stt:'P1', cat:'pres', name:'Pressure Gauge – Đồng hồ đo áp cơ học', sub:'Bourdon tube · Diaphragm · Bellows · Đọc tại chỗ',
        cells:[
          { l:'Phần tử đo',     c:[{t:'Bourdon tube (xoắn/C-type)',k:'pressure_mech'},{t:'Diaphragm',k:'pressure_mech'},{t:'Bellows/Capsule',k:'pressure_mech'}] },
      ...
      { id:4, stt:'P2', cat:'pres', name:'Pressure Transmitter – Cảm biến áp điện tử', sub:'Capacitance · 4-20mA HART · Gauge/Absolute/Differential · Rosemount 3051',
        cells:[
          { l:'Nguyên lý điện tử', c:[{t:'Differential Capacitance',k:'dp_cell'},{t:'Piezoresistive',k:'piezores'}] },
          { l:'Loại đo',          c:[{t:'Gauge (so với khí quyển)'},{t:'Absolute (so với chân không)'},{t:'Differential ΔP = P₁−P₂',k:'dp_cell'}] },
          { l:'Tín hiệu ra',      c:[{t:'4-20mA + HART',k:'tx_4_20'},{t:'FF H1',k:'ff_fieldbus'}] },
      ...
      { id:7, stt:'L2', cat:'level', name:'DP Level – Đo mức bằng áp suất thủy tĩnh', sub:'ΔP=ρgh · Dry leg · Wet leg · Compensated leg · Rosemount 3051',
        cells:[
          ...
          { l:'Bình kín (Wet)',  c:[{t:'Compensated leg (hơi)',k:'dp_level_comp'},{t:'Suppression/Elevation',k:'dp_level_comp'}] },
      ...
      { id:12, stt:'F2', cat:'flow', name:'DP Flowmeter – Venturi & Annubar', sub:'Venturi: ΔP thấp · Annubar: pitot trung bình · ISO 5167',
        cells:[
          { l:'Venturi',    c:[{t:'Phục hồi áp tốt (~90%)',k:'venturi_pitot'},{t:'Chính xác cao ±0.3%',k:'venturi_pitot'}] },
          { l:'Annubar',    c:[{t:'Averaging Pitot Tube',k:'venturi_pitot'},{t:'Ít tổn thất áp',k:'venturi_pitot'},{t:'Ống lớn D>200mm',k:'venturi_pitot'}] },
